export const mastersConfig = {
  ...
  'purchase-indents': {
    ...
    columns: [
      ...
      { key: 'type', label: 'Type' },
      { key: 'priorityId', label: 'Priority', type: 'ref' },
    ...
    fields: [
      ...
      { name: 'priorityId', label: 'Priority', type: 'select', refEndpoint: 'priorities', refLabel: 'priorityName' },
      { name: 'purposeOfIndent', label: 'Purpose Of Indent', type: 'textarea', required: true },
      { name: 'material', label: 'Material Req', type: 'text' },
      { name: 'adminApproval', label: 'Admin Approval', type: 'select', options: [{ label: 'Pending', value: 'Pending' }, { label: 'Approved', value: 'Approved' }, { label: 'Rejected', value: 'Rejected' }] },
      { name: 'indentStatus', label: 'Status', type: 'select', options: [{ label: 'Raised', value: 'Raised' }, { label: 'Approved', value: 'Approved' }, { label: 'Rejected', value: 'Rejected' }, { label: 'Pending', value: 'Pending' }] },
      { name: 'raisedByName', label: 'Raised By', type: 'text' },
      { name: 'pmPdApproval', label: 'PM/PD Approval', type: 'select', options: [{ label: 'Pending', value: 'Pending' }, { label: 'Approved', value: 'Approved' }, { label: 'Rejected', value: 'Rejected' }] },
    ],
  },
  'filling-stations': {
